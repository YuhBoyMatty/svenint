...
* **Movement:** Air Run, Auto Jump, Auto Ceil-Clipping, Auto Edgejump, Fastrun, Auto Jumpbug, Auto Selfsink, Auto Strafer, Auto Wallstrafe
...
* **Misc:** Anti Sound Spam (Studio Events), Bypass Cvar Query, Game Patches (Tertiary Attack Glitch / Unlock 31 FPS at map loading), Ignore Different Map Versions, Mute Manager (Useless since 5.26), No Sleep (When the game is minimized), Private Chat (Encrypted messages, use chat command: /pm your text goes next), Soundcache (Saves downloaded soundcache to enter the server faster), Votebot
...
### Launch Parameters
* **-sint_noconsole:** disable debug console (enabled by default)
* **-sint_keepconsole:** prevent debug console from closing
