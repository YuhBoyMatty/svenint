#ifndef SINT_IGAMEUI_H
#define SINT_IGAMEUI_H
...
public:
	...
	virtual void	Start( struct cl_enginefuncs_s *engineFuncs, int interfaceVersion, IFileSystem *system ) = 0;
