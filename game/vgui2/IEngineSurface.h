...
#ifndef SINT_IENGINESURFACE_H
#define SINT_IENGINESURFACE_H
...
public:
	...
	virtual void DrawPrintChar( int, int, int, int, float, float, float, float ) = 0;
	virtual void DrawPrintCharAdd( int, int, int, int, float, float, float, float ) = 0;
	virtual void DrawSetTextureFile( int id, const char *filename, int hardwareFilter, bool forceReload ) = 0;
	virtual void DrawGetTextureSize( int id, int &wide, int &tall ) = 0;
	virtual bool IsTextureIDValid( int id ) = 0;
	virtual void DrawSetSubTextureRGBA( int nTextureID, int x, int y, const unsigned char *pchData, int wide, int tall ) = 0;
