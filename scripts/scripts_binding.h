...
#ifndef SINT_LUA_SCRIPTS_BINDING_H
#define SINT_LUA_SCRIPTS_BINDING_H
...
VLUA_DECLARE_DEDUCE_FIELDTYPE( VLUA_FIELD_TYPE_INTEGER64, int64_t );
...
VLUA_DECLARE_DEDUCE_FIELDTYPE( VLUA_FIELD_TYPE_UINT, uint32_t );
VLUA_DECLARE_DEDUCE_FIELDTYPE( VLUA_FIELD_TYPE_UINT16, uint16_t );
VLUA_DECLARE_DEDUCE_FIELDTYPE( VLUA_FIELD_TYPE_UINT64, uint64_t );
...
namespace VLua
{
	...
	template <class T> inline void RegisterGlobalVariable( const char *pszVariableName, T variable )
	{
...
#endif // SINT_LUA_SCRIPTS_BINDING_H