...
namespace VLua
{
	...
	void PushScriptVariant( void *pVariable, int fieldtype, bool pointer )
	{
		...
		case VLUA_FIELD_TYPE_INTEGER64:
			lua_pushinteger( pLuaState, ( lua_Integer ) * (int64_t *)pVariable );
			break;
		...
		case VLUA_FIELD_TYPE_UINT:
			lua_pushinteger( pLuaState, ( lua_Integer ) * (uint32_t *)pVariable );
			break;
		case VLUA_FIELD_TYPE_UINT16:
			lua_pushinteger( pLuaState, ( lua_Integer ) * (uint16_t *)pVariable );
			break;
		case VLUA_FIELD_TYPE_UINT64:
			lua_pushinteger( pLuaState, ( lua_Integer ) * (uint64_t *)pVariable );
			break;
		case VLUA_FIELD_TYPE_COLOR32:
			Warning( "Implement VLUA_FIELD_TYPE_COLOR32\n" );
			break;
		...
		case VLUA_FIELD_TYPE_VECTOR2D:
			Warning( "Implement VLUA_FIELD_TYPE_VECTOR2D\n" );
			break;
		case VLUA_FIELD_TYPE_QANGLE:
			Warning( "Implement VLUA_FIELD_TYPE_QANGLE\n" );
			break;
		case VLUA_FIELD_TYPE_QUATERNION:
			Warning( "Implement VLUA_FIELD_TYPE_QUATERNION\n" );
			break;
		...
		case VLUA_FIELD_TYPE_STRING:
			lua_pushstring( pLuaState, Globals::gpGlobals->pStringBase + *(string_t *)pVariable );
			break;
		...
		case VLUA_FIELD_TYPE_GLOBALVARS:
			...
			break;
		default:
			Warning( "Passing VLUA_FIELD_TYPE_TYPEUNKNOWN!\n" );
			break;
		}
	}
	...
	void ConvertToScriptVariant( void *pVariable, int fieldtype, int idx )
	{
		...
		case VLUA_FIELD_TYPE_SHORT:
			*(short *)pVariable = (short)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_INTEGER64:
			*(int64_t *)pVariable = (int64_t)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_BOOLEAN:
		...
		case VLUA_FIELD_TYPE_CHARACTER:
			*(char *)pVariable = (char)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_UINT:
			*(uint32_t *)pVariable = (uint32_t)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_UINT16:
			*(uint16_t *)pVariable = (uint16_t)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_UINT64:
			*(uint64_t *)pVariable = (uint64_t)lua_tointeger( pLuaState, idx );
			break;
		case VLUA_FIELD_TYPE_COLOR32:
			Warning( "Implement VLUA_FIELD_TYPE_COLOR32" );
			break;
		...
		case VLUA_FIELD_TYPE_STRING:
		{
			...
			//Warning( "Implement VLUA_FIELD_TYPE_STRING" );
			break;
		}
		case VLUA_FIELD_TYPE_USERCMD:
