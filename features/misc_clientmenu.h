...
#ifndef SINT_FEATURE_CLIENTMENU_H
#define SINT_FEATURE_CLIENTMENU_H
...
class CClientMenu final : public CBaseFeature, IHookEventListener
{
public:
	CClientMenu( const char *pszCategoryName, const char *pszName );
...
EXTERN_FEATURE( CClientMenu, clientmenu );

#endif // SINT_FEATURE_CLIENTMENU_H