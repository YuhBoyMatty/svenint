...
#define SVENINT_MINOR_VERSION 2
#define SVENINT_PATCH_VERSION 4
...
#define SVENINT_VERSION_STRING SVENINT_MAJOR_VERSION_STRING "." SVENINT_MINOR_VERSION_STRING "." SVENINT_PATCH_VERSION_STRING

#define SVENINT_VERSION_CHECK( major, minor, patch ) ( ( major << 16 ) | ( minor << 8 ) | ( patch ) )
#define SVENINT_VERSION() SVENINT_VERSION_CHECK( SVENINT_MAJOR_VERSION, SVENINT_MINOR_VERSION, SVENINT_PATCH_VERSION )
