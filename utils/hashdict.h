...
#ifndef SINT_HASHDICT_H
#define SINT_HASHDICT_H
...
public:
	...
	T *Insert( const char *pszKey, const T &value, void ( *pfnOnInsertFailed )( T *pFoundValue, T *pInsertValue ) = NULL );
...
template <class T, bool bCaseInsensitive, bool bDupeStrings>
inline T *CHashDict<T, bCaseInsensitive, bDupeStrings>::Insert( const char *pszKey, const T &value, void ( *pfnOnInsertFailed )( T *pFoundValue, T *pInsertValue ) /* = NULL */ )
{
	unsigned int hash = HashKey( pszKey );
	int index = hash % m_Size;
...
template <class T, bool bCaseInsensitive, bool bDupeStrings>
inline unsigned int CHashDict<T, bCaseInsensitive, bDupeStrings>::HashKey( const char *pszKey ) const
{
	unsigned int hash;
