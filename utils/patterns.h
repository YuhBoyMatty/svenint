...
#ifndef SINT_PATTERNS_H
#define SINT_PATTERNS_H
...
#define DEFINE_PATTERN( name, signature ) struct svenint_pattern_inner_wrapper<__svenint_get_pattern_length( signature ), (unsigned char)0x2A> __pattern_##name( signature ); \
	struct pattern_t *name = reinterpret_cast<struct pattern_t *>( &( __pattern_##name ) )

#define DEFINE_PATTERN_IGNORE_BYTE( name, signature, ignorebyte ) struct svenint_pattern_inner_wrapper<__svenint_get_pattern_length( signature ), (unsigned char)ignorebyte> __pattern_##name( signature ); \
	struct pattern_t *name = reinterpret_cast<struct pattern_t *>( &( __pattern_##name ) )
...
static constexpr int __svenint_hex_to_decimal_table[] =
{
...
static inline constexpr int __svenint_hex_to_decimal_fast( char *hex )
{
	int result = 0;

	while ( *hex != '\0' && result >= 0 )
	{
		result = ( result << 4 ) | __svenint_hex_to_decimal_table[ *hex++ ];
	}

	return result;
}

static inline constexpr unsigned int __svenint_get_pattern_length( const char *pszPattern )
{
	unsigned int nCount = 0;

	while ( *pszPattern != '\0' )
	{
		const char symbol = *pszPattern;
		if ( symbol != ' ' )
		{
			nCount++;
...
struct svenint_pattern_inner_wrapper
{
...
#define _DEFINE_PATTERN_STATIC_NAMED( name, signature ) static struct svenint_pattern_inner_wrapper<__svenint_get_pattern_length( signature ), (unsigned char)0x2A> name( signature )
...
#define GET_PATTERN_NAME_BY_INDEX( pattern_name, ndx ) pattern_name[ ndx ].name
...
#define _DEFINE_PATTERNS_2( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2 ) \
	_DEFINE_PATTERN_STATIC_NAMED( pattern1, signature1 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern2, signature2 ); \
...
#define _DEFINE_PATTERNS_3( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3 ) \
	_DEFINE_PATTERN_STATIC_NAMED( pattern1, signature1 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern2, signature2 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern3, signature3 ); \
...
#define _DEFINE_PATTERNS_4( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern2, signature2 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern3, signature3 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern4, signature4 ); \
...
#define _DEFINE_PATTERNS_5( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern3, signature3 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern4, signature4 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern5, signature5 ); \
...
#define _DEFINE_PATTERNS_6( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5, pattern6, pattern6_str, signature6 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern4, signature4 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern5, signature5 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern6, signature6 ); \
...
#define _DEFINE_PATTERNS_7( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5, pattern6, pattern6_str, signature6, pattern7, pattern7_str, signature7 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern5, signature5 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern6, signature6 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern7, signature7 ); \
...
#define _DEFINE_PATTERNS_8( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5, pattern6, pattern6_str, signature6, pattern7, pattern7_str, signature7, pattern8, pattern8_str, signature8 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern6, signature6 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern7, signature7 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern8, signature8 ); \
...
#define _DEFINE_PATTERNS_9( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5, pattern6, pattern6_str, signature6, pattern7, pattern7_str, signature7, pattern8, pattern8_str, signature8, pattern9, pattern9_str, signature9 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern7, signature7 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern8, signature8 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern9, signature9 ); \
...
#define _DEFINE_PATTERNS_10( name, pattern1, pattern1_str, signature1, pattern2, pattern2_str, signature2, pattern3, pattern3_str, signature3, pattern4, pattern4_str, signature4, pattern5, pattern5_str, signature5, pattern6, pattern6_str, signature6, pattern7, pattern7_str, signature7, pattern8, pattern8_str, signature8, pattern9, pattern9_str, signature9, pattern10, pattern10_str, signature10 ) \
	...
	_DEFINE_PATTERN_STATIC_NAMED( pattern8, signature8 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern9, signature9 ); \
	_DEFINE_PATTERN_STATIC_NAMED( pattern10, signature10 ); \
...
// DEFINE_PATTERNS_N
#define DEFINE_PATTERNS_1( name, pattern1, signature1 ) \
	_DEFINE_PATTERNS_1( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1 )

#define DEFINE_PATTERNS_2( name, pattern1, signature1, pattern2, signature2 ) \
	_DEFINE_PATTERNS_2( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2 )

#define DEFINE_PATTERNS_3( name, pattern1, signature1, pattern2, signature2, pattern3, signature3 ) \
	_DEFINE_PATTERNS_3( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3 )

#define DEFINE_PATTERNS_4( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4 ) \
	_DEFINE_PATTERNS_4( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4 )

#define DEFINE_PATTERNS_5( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5 ) \
	_DEFINE_PATTERNS_5( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		_PATTERN_DEDUCE_NAME( arg5, __COUNTER__ ), pattern5, signature5 )

#define DEFINE_PATTERNS_6( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5, pattern6, signature6 ) \
	_DEFINE_PATTERNS_6( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		_PATTERN_DEDUCE_NAME( arg5, __COUNTER__ ), pattern5, signature5, \
		_PATTERN_DEDUCE_NAME( arg6, __COUNTER__ ), pattern6, signature6 )

#define DEFINE_PATTERNS_7( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5, pattern6, signature6, pattern7, signature7 ) \
	_DEFINE_PATTERNS_7( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		_PATTERN_DEDUCE_NAME( arg5, __COUNTER__ ), pattern5, signature5, \
		_PATTERN_DEDUCE_NAME( arg6, __COUNTER__ ), pattern6, signature6, \
		_PATTERN_DEDUCE_NAME( arg7, __COUNTER__ ), pattern7, signature7 )

#define DEFINE_PATTERNS_8( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5, pattern6, signature6, pattern7, signature7, pattern8, signature8 ) \
	_DEFINE_PATTERNS_8( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		...
		_PATTERN_DEDUCE_NAME( arg6, __COUNTER__ ), pattern6, signature6, \
		_PATTERN_DEDUCE_NAME( arg7, __COUNTER__ ), pattern7, signature7, \
		_PATTERN_DEDUCE_NAME( arg8, __COUNTER__ ), pattern8, signature8 )

#define DEFINE_PATTERNS_9( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5, pattern6, signature6, pattern7, signature7, pattern8, signature8, pattern9, signature9 ) \
	_DEFINE_PATTERNS_9( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		...
		_PATTERN_DEDUCE_NAME( arg7, __COUNTER__ ), pattern7, signature7, \
		_PATTERN_DEDUCE_NAME( arg8, __COUNTER__ ), pattern8, signature8, \
		_PATTERN_DEDUCE_NAME( arg9, __COUNTER__ ), pattern9, signature9 )

#define DEFINE_PATTERNS_10( name, pattern1, signature1, pattern2, signature2, pattern3, signature3, pattern4, signature4, pattern5, signature5, pattern6, signature6, pattern7, signature7, pattern8, signature8, pattern9, signature9, pattern10, signature10 ) \
	_DEFINE_PATTERNS_10( name, \
		_PATTERN_DEDUCE_NAME( arg1, __COUNTER__ ), pattern1, signature1, \
		_PATTERN_DEDUCE_NAME( arg2, __COUNTER__ ), pattern2, signature2, \
		_PATTERN_DEDUCE_NAME( arg3, __COUNTER__ ), pattern3, signature3, \
		_PATTERN_DEDUCE_NAME( arg4, __COUNTER__ ), pattern4, signature4, \
		...
		_PATTERN_DEDUCE_NAME( arg8, __COUNTER__ ), pattern8, signature8, \
		_PATTERN_DEDUCE_NAME( arg9, __COUNTER__ ), pattern9, signature9, \
		_PATTERN_DEDUCE_NAME( arg10, __COUNTER__ ), pattern10, signature10 )

// Auto select DEFINE_PATTERNS_N macro
#define _SELECT_PATTERNS_MACRO( \
	_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, \
	_11, _12, _13, _14, _15, _16, _17, _18, _19, _20, \
	macro, ... ) macro

#define DEFINE_PATTERNS( name, ... ) \
	_PATTERN_EXPAND( _SELECT_PATTERNS_MACRO( __VA_ARGS__, \
		DEFINE_PATTERNS_10, DEFINE_PATTERNS_10, \
		DEFINE_PATTERNS_9, DEFINE_PATTERNS_9, \
		DEFINE_PATTERNS_8, DEFINE_PATTERNS_8, \
		DEFINE_PATTERNS_7, DEFINE_PATTERNS_7, \
		DEFINE_PATTERNS_6, DEFINE_PATTERNS_6, \
		DEFINE_PATTERNS_5, DEFINE_PATTERNS_5, \
		DEFINE_PATTERNS_4, DEFINE_PATTERNS_4, \
		DEFINE_PATTERNS_3, DEFINE_PATTERNS_3, \
		DEFINE_PATTERNS_2, DEFINE_PATTERNS_2, \
		DEFINE_PATTERNS_1, DEFINE_PATTERNS_1 )( name, __VA_ARGS__ ) )

#endif // SINT_PATTERNS_H
