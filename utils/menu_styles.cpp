...
static void StyleColors_SvenInt( void )
{
	colors[ ImGuiCol_WindowBg ] = ImColor( 80, 80, 80, 230 );
...
static void StyleColors_Dark( void )
{
...
static void StyleColors_Classic( void )
{
...
static void StyleColors_Light( void )
{
...
static void StyleColors_Berserk( void )
{
...
static void StyleColors_DeepDark( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 1.00f, 1.00f, 1.00f, 1.00f );
...
static void StyleColors_Carbon( void )
{
...
static void StyleColors_CorporateGrey( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 1.00f, 1.00f, 1.00f, 1.00f );
...
static void StyleColors_Grey( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 1.00f, 1.00f, 1.00f, 1.00f );
...
static void StyleColors_GoldBlack( void )
{
	...
	colors[ ImGuiCol_FrameBg ] = ImVec4( 0.11f * 0.33f, 0.11f * 0.33f, 0.11f * 0.33f, 1.00f );
...
static void StyleColors_Monochrome( void )
{
...
static void StyleColors_DarkLight( void )
{
...
static void StyleColors_SoftDark( void )
{
...
static void StyleColors_Pink( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 0.00, 0.00, 0.00, 1.00 );
	colors[ ImGuiCol_MenuBarBg ] = ImVec4( 0.77, 0.49, 0.66, 1.00 );
...
static void StyleColors_HalfLife( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 1.00f, 1.00f, 1.00f, 1.00f );
	...
	colors[ ImGuiCol_FrameBg ] = ImVec4( 0.24f * 0.7f, 0.27f * 0.7f, 0.20f * 0.7f, 1.00f );
	...
	colors[ ImGuiCol_Button ] = ImVec4( 0.29f * 1.5f, 0.34f * 1.5f, 0.26f * 1.5f, 0.40f );
...
static void StyleColors_SvenCope( void )
{
	colors[ ImGuiCol_Text ] = ImVec4( 1.00f, 1.00f, 1.00f, 1.00f );
	...
	colors[ ImGuiCol_FrameBg ] = ImVec4( 43.f / 255.f, 47.f / 255.f, 60.f / 255.f, 1.00f );
	...
	colors[ ImGuiCol_Button ] = ImVec4( 43.f / 255.f, 47.f / 255.f, 60.f / 255.f, 1.00f );
...
{
	const menu_custom_theme_vars *vars = Modules::menu->GetCustomThemeVars();

	colors[ ImGuiCol_WindowBg ] = ImGui::ColorConvertU32ToFloat4( vars->WindowBg->GetInt() );
	colors[ ImGuiCol_Border ] = ImGui::ColorConvertU32ToFloat4( vars->Border->GetInt() );
	colors[ ImGuiCol_Button ] = ImGui::ColorConvertU32ToFloat4( vars->Button->GetInt() );
	colors[ ImGuiCol_ButtonActive ] = ImGui::ColorConvertU32ToFloat4( vars->ButtonActive->GetInt() );
	colors[ ImGuiCol_ButtonHovered ] = ImGui::ColorConvertU32ToFloat4( vars->ButtonHovered->GetInt() );
	colors[ ImGuiCol_FrameBg ] = ImGui::ColorConvertU32ToFloat4( vars->FrameBg->GetInt() );
	colors[ ImGuiCol_FrameBgActive ] = ImGui::ColorConvertU32ToFloat4( vars->FrameBgActive->GetInt() );
	colors[ ImGuiCol_FrameBgHovered ] = ImGui::ColorConvertU32ToFloat4( vars->FrameBgHovered->GetInt() );
	colors[ ImGuiCol_Text ] = ImGui::ColorConvertU32ToFloat4( vars->Text->GetInt() );
	colors[ ImGuiCol_ChildBg ] = ImGui::ColorConvertU32ToFloat4( vars->ChildBg->GetInt() );
	colors[ ImGuiCol_CheckMark ] = ImGui::ColorConvertU32ToFloat4( vars->CheckMark->GetInt() );
	colors[ ImGuiCol_SliderGrab ] = ImGui::ColorConvertU32ToFloat4( vars->SliderGrab->GetInt() );
	colors[ ImGuiCol_SliderGrabActive ] = ImGui::ColorConvertU32ToFloat4( vars->SliderGrabActive->GetInt() );
	colors[ ImGuiCol_Header ] = ImGui::ColorConvertU32ToFloat4( vars->Header->GetInt() );
	colors[ ImGuiCol_HeaderHovered ] = ImGui::ColorConvertU32ToFloat4( vars->HeaderHovered->GetInt() );
	colors[ ImGuiCol_HeaderActive ] = ImGui::ColorConvertU32ToFloat4( vars->HeaderActive->GetInt() );
	colors[ ImGuiCol_ResizeGripActive ] = ImGui::ColorConvertU32ToFloat4( vars->ResizeGripActive->GetInt() );
	colors[ ImGuiCol_SeparatorActive ] = ImGui::ColorConvertU32ToFloat4( vars->SeparatorActive->GetInt() );
	colors[ ImGuiCol_TitleBgActive ] = ImGui::ColorConvertU32ToFloat4( vars->TitleBgActive->GetInt() );
	colors[ ImGuiCol_Separator ] = ImGui::ColorConvertU32ToFloat4( vars->Separator->GetInt() );
}
...
void SaveCurrentStyle( void ) // call on initialization after StyleColorsDarkTheme
{
